...
- Machine-specific filesystem paths (`/Users/amin/...`)
...
|---|---|---|
| `/Users/amin/.agents/orchestrator-shared/ORCHESTRATOR_CORE.md` in skill headers | `MACHINE_SPECIFIC_PATH` | Sanitized to portable `~/.agents/...` path |
