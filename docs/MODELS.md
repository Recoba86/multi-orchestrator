...
|---|---|---|---|---|
| `SOL_HIGH` | `gpt-5.6-sol` | `openai_plus_capacity` | `[low, medium, high, xhigh, max, ultra]` | `high` (request-contract boss) |
| `GROK_4_6_HIGH` | `nine-router/gcli/grok-4.6-high` | `xai_gcli_capacity` | `[high, max]` | `high` (request-contract boss) |
